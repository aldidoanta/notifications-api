...
@pytest.mark.parametrize(['starting_priorities', 'expected_priorities'], [
    ...
    # document what happens if they have unexpected values outside of the 0 - 100 range
    # the code never causes further issues, but sometimes doesn't actively reset the vaues to 0-100.
